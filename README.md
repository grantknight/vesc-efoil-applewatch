This is a usable **watch-only** Apple Watch app built in Xcode. After compiling and sending it to Apple Watch, it connects to VESC via Bluetooth LE and displays live telemetry—no iPhone required.

### Features

- **Dashboard** (large type): speed, watts, battery %, MOS/motor temps
- **Live data**: VESC speed, GPS speed (on by default), voltage, RPM, current
- **Session stats**: avg/max power, current, temperature, run time
- **Battery %**: from VESC BMS level or configurable cell-count voltage curve (Settings)
- **Auto-reconnect** to last paired VESC
